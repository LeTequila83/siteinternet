...
const I18N = {
  ...
  "about.title": { fr: "Une table conviviale, sous les pins", en: "A friendly table, under the pines", es: "Una mesa acogedora, bajo los pinos", it: "Una tavola conviviale, sotto i pini", de: "Ein geselliger Tisch, unter den Pinien" },
  "about.text":  { fr: "Au Tequila, on partage une cuisine généreuse et de saison — pizzas au feu de bois, viandes, poissons, salades et cocktails maison — à déguster en terrasse, face au Domaine du Pin de la Lègue à Fréjus.",
                   en: "At Le Tequila we share generous, seasonal cooking — wood-fired pizzas, meats, fish, salads and homemade cocktails — to enjoy on the terrace, opposite the Domaine du Pin de la Lègue in Fréjus.",
                   es: "En Le Tequila compartimos una cocina generosa y de temporada — pizzas a la leña, carnes, pescados, ensaladas y cócteles caseros — para disfrutar en la terraza, frente al Domaine du Pin de la Lègue en Fréjus.",
                   it: "Da Le Tequila condividiamo una cucina generosa e di stagione — pizze al forno a legna, carni, pesce, insalate e cocktail della casa — da gustare in terrazza, di fronte al Domaine du Pin de la Lègue a Fréjus.",
                   de: "Im Le Tequila teilen wir großzügige, saisonale Küche — Holzofen-Pizzen, Fleisch, Fisch, Salate und hausgemachte Cocktails — auf der Terrasse, gegenüber der Domaine du Pin de la Lègue in Fréjus." },
  ...
  "hero.tagline":{ fr: "Cuisine généreuse & pizzas au feu de bois, sous les pins de Fréjus.", en: "Generous cooking & wood-fired pizzas, under the pines of Fréjus.", es: "Cocina generosa y pizzas a la leña, bajo los pinos de Fréjus.", it: "Cucina generosa e pizze al forno a legna, sotto i pini di Fréjus.", de: "Großzügige Küche & Pizza aus dem Holzofen, unter den Pinien von Fréjus." },
